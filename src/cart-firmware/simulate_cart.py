...
def on_command_received(client, userdata, message):
    ...
    try:
        ...
        # --- NEW DISPATCH COMMAND BLOCK FOR HARDWARE TEAM ---
            ...
            print(f"🚚 ACTION: ORDER DISPATCHED!")
            print(f"📍 New Target: {cust_name} at {address}")
            print(f"🌐 GPS Coordinates: Lat {dest_lat}, Lon {dest_lon}")
            print("⚙️ Initiating path planning algorithms to destination...")
            # Here, the hardware team will pass these coordinates to their ROS/Navigation stack!
